defmodule PaintByNumber do
  ...
  def palette_bit_size(color_count), do: get_exponent(0, color_count)

  @spec get_exponent(pos_integer(), pos_integer()) :: pos_integer()
  defp get_exponent(exponent, number) do
    if Integer.pow(2, exponent) >= number, do: exponent, else: get_exponent(exponent + 1, number)
  end
