defmodule AllYourBase do
  @output_base_error_message "output base must be >= 2"
  @input_base_error_message "input base must be >= 2"
  ...
  def convert(_, _, output_base) when output_base < 2, do: {:error, @output_base_error_message}
  def convert(_, input_base, _) when input_base < 2, do: {:error, @input_base_error_message}
